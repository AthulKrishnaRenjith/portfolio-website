...
const PROJECTS = [
  {
    ...
    bullets: [
      'Achieved 67% mAP@0.5:0.95 and sub-5cm drift during field trials in GNSS-denied coastal conditions',
      'Integrated perception, localisation and navigation within 50Hz control-loop timing constraints',
      'Optimised memory footprint of localisation to allow concurrent execution of navigation and perception modules on embedded hardware',
    ],
    featured: true,
  },
  {
    ...
    desc: 'Trained and transferred a PPO-based locomotion policy for a humanoid robot.',
    bullets: [
      'Trained PPO-based locomotion policy achieving 0.18 m/s stable walking with under 3% fall rate',
  ...
  },
  {
    ...
    stack: ['YOLOv5', 'OpenVINO', 'ROS2', 'ONNX', 'Webots'],
    desc: 'Real-time perception system for humanoid soccer robots.',
    bullets: [
